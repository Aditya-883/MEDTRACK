...
export default function Home() {
  ...
  return (
    <div className="flex">
      ...
      <div
        className="ml-16 flex-1 min-h-screen flex flex-col
        ...
        <div className="flex flex-col items-center flex-grow px-6 py-10">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 max-w-6xl w-full">
            <div className="max-w-xl">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                It ensures transparency, security, and fast access to medical information for better
                healthcare services.
              </p>
            </div>
            <div className="relative">
              <img
                ...
                alt="hero"
              />
              <div className="absolute inset-0 bg-blue-400 opacity-20 blur-3xl rounded-full" />
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-16 max-w-6xl w-full">
            {[
              ...
              <div
                key={item.title}
                className="p-6 rounded-2xl bg-white/60 dark:bg-gray-800/60 backdrop-blur-lg shadow-md"
              >
          ...
          <div className="mt-20 max-w-6xl w-full">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Link
                to="/admin"
                className="p-6 rounded-2xl bg-purple-500 text-white shadow-lg hover:bg-purple-600 transition"
              >
              ...
              <Link
                to="/doctor"
                className="p-6 rounded-2xl bg-blue-500 text-white shadow-lg hover:bg-blue-600 transition"
              >
              ...
              <Link
                to="/patient"
                className="p-6 rounded-2xl bg-teal-500 text-white shadow-lg hover:bg-teal-600 transition"
              >
