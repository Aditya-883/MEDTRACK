      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            <h1 className="text-xl font-semibold text-white tracking-wide">MedTrack</h1>
            <p className="text-sm text-gray-400 mt-1">Secure • Transparent • Decentralized Healthcare</p>
          </div>

          <div className="flex flex-wrap justify-center gap-4 text-sm">
            {['Blockchain Security', 'End-to-End Encryption', 'Privacy First'].map((f) => (
              <span key={f} className="hover:text-white transition duration-300 cursor-default">
                {f}
              </span>
            ))}
          </div>
          ...
          <div className="flex gap-5 text-lg">
            <a href="https://github.com/Aditya-883/MEDTRACK" target="_blank" rel="noopener noreferrer" title="GitHub">
              <FaGithub className="hover:text-white cursor-pointer transition duration-300" />
            </a>
            <a href="https://www.linkedin.com/in/khushi-tripathi-6423b0253/" target="_blank" rel="noopener noreferrer" title="LinkedIn">
              <FaLinkedin className="hover:text-blue-500 cursor-pointer transition duration-300" />
            </a>
            <a href="mailto:khushitripathi0706@gmail.com" title="Email">
